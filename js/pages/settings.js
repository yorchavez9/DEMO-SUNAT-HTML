      ...
      + '<div style="max-width: 42rem;">'
        ...
        + '<div class="card" style="display: flex; flex-direction: column; gap: 1rem;">'
          + '<div>'
            ...
            + '<input id="s-base-url" class="input" value="' + App.escapeHtml(this.config.base_url) + '" placeholder="https://apisunatv2.kodevo.es/api/v1" />'
            + '<p class="text-xs" style="color: rgb(100 116 139); margin-top: 0.25rem;">Ejemplo: https://apisunatv2.kodevo.es/api/v1 o tu URL propia</p>'
          + '</div>'
          + '<div>'
