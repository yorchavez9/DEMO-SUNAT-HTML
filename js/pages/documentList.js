          ...
          + '<div class="card" style="margin-bottom: 1rem;">'
            + '<div style="display: flex; flex-direction: column; gap: 0.75rem;" class="filter-row">'
              ...
              + '<div>'
                ...
                + '<select id="dl-estado" class="input js-select">'
            ...
            + '<div style="padding:1.25rem 1.5rem;display:flex;flex-direction:column;gap:1.25rem;">'
              ...
              + '<div>'
                ...
                + '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0.75rem;">'
                  ...
                  + '<div><label class="label">Moneda</label><select id="nota-moneda" class="input js-select"><option value="PEN"' + (formData.tipo_moneda === 'PEN' ? ' selected' : '') + '>PEN</option><option value="USD"' + (formData.tipo_moneda === 'USD' ? ' selected' : '') + '>USD</option></select></div>'
                + '</div>'
              + '</div>'
              + '<div>'
                ...
                + '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0.75rem;">'
                  + '<div><label class="label">Tipo</label><select id="nota-afec-tipo" class="input js-select"><option value="01"' + (formData.doc_afectado_tipo === '01' ? ' selected' : '') + '>01 - Factura</option><option value="03"' + (formData.doc_afectado_tipo === '03' ? ' selected' : '') + '>03 - Boleta</option></select></div>'
              ...
              + '<div>'
                ...
                + '<div style="display:flex;flex-direction:column;gap:0.75rem;">'
                  + '<select id="nota-cod-motivo" class="input js-select" data-search="true" data-search-placeholder="Buscar motivo...">' + motivosOpts + '</select>'
